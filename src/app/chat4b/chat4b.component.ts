...
export class Chat4bComponent implements OnInit, OnDestroy 
{
  mensajesTraidos: any[] = []
  subscription: any;
  constructor(private chatService: ChatService,private routerRecieved:Router) { 
  ...
  ngOnInit() 
  {
    ...
    //-------------------------------------------------------------
    this.subscription =this.chatService.TraerChats2().subscribe(mensajes => {
  ...
  scrollToTheLastElementByClassName(){
    ...
    //@ts-ignore
    document.getElementById('card-container-chat').scrollTop = toppos;
  }
}
